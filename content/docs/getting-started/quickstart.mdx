...
Open the [xVault dapp](https://xvaultsol.com), connect your wallet, and choose one of the curated SKUs:
...
Navigate to [xvaultsol.com/stake](https://xvaultsol.com/stake). Balances and lockup tiers are shown per-wallet.
...
You claim from [xvaultsol.com/rewards](https://xvaultsol.com/rewards) with an inclusion proof. Unclaimed rewards roll into the next epoch — they are never forfeited.
